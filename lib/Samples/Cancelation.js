...
const csdParams = {
  ...
  CancelationService.Set(csdParams).CancelationByUUID((err, res) => {
	if (err) {
...
const pfxParams = {
  ...
  CancelationService.Set(pfxParams).CancelationByPFX((err, res) => {
	if (err) {
	  console.error("Error:", err);
	} else {
	  console.log(res);
...
CancelationService.Set(xmlParams).CancelationByXML((err, res) => {
	if (err) {
	  console.error("Error:", err);
	} else {
	  console.log(res);
...
CancelationService.Set(uuidParams).CancelationByUUID((err, res) => {
	if (err) {
	  console.error("Error:", err);
	} else {
	  console.log(res);
