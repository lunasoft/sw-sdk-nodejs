...
describe('AccountBalanceService', function () {
	this.timeout(30000);

	describe('GetAccountBalance', function () {
		it('SuccessGetBalanceByAuth', done => {
			const params = {
				url:      SERVICES_URL,
				urlApi:   API_URL,
				user:     SDKTEST_USER,
		...
		it('SuccessGetBalanceByToken', done => {
			const params = { 
				urlApi: API_URL, 
				token:  SDKTEST_TOKEN 
			};
		...
		it('ErrorGetBalanceByToken', done => {
			const params = {
				urlApi: API_URL,
				token:  '1'
			};
	...
	describe('AddStamps', function () {
		it('SuccessAddStampsByToken', done => {
			const params = { 
				urlApi: API_URL, 
				token: SDKTEST_TOKEN 
			};
		...
		it('SuccessAddStampsByAuth', done => {
			const params = {
				url:      SERVICES_URL,
				urlApi:   API_URL,
				user:     SDKTEST_USER,
	...
	describe('RemoveStamps', function () {
		it('SuccessRemoveStampsByToken', done => {
			const params = { 
				urlApi: API_URL, 
				token: SDKTEST_TOKEN 
			};
		...
		it('SuccessRemoveStampsByAuth', done => {
			const params = {
				url:      SERVICES_URL,
				urlApi:   API_URL,
				user:     SDKTEST_USER,
