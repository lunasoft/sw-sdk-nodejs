...
describe('CancelationService.js', function () {
	...
	describe('CancelationServiceByUUID', function () {
		this.timeout(15000);
		var result = 'error';
		var msg = '';
	...
	describe('CancelationServiceByCSD', function () {
		this.timeout(15000);
		var result = 'error';
		var msg = '';
	...
	describe('CancelationServiceByPFX', function () {
		this.timeout(15000);
		var result = 'error';
		var msg = '';
	...
	describe('CancelationServiceByXML', function () {
		this.timeout(15000);
		var result = 'error';
		var msg = '';
